...
if not _deepgram_api_key:
    logger.warning('STARTUP: DEEPGRAM_API_KEY missing; pre-recorded transcription will fail at request time.')
    _deepgram_api_key = 'not-set'
_deepgram_client = DeepgramClient(_deepgram_api_key, _deepgram_options)
