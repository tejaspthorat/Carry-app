...
_openai_api_key = os.getenv('OPENAI_API_KEY') or 'not-set'
if _openai_api_key == 'not-set':
    logger.warning('STARTUP: OPENAI_API_KEY missing; chat file upload features will fail at request time.')
_async_openai = AsyncOpenAI(api_key=_openai_api_key)
