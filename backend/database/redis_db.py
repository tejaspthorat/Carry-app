...
def _get_redis_port() -> int:
    raw_port = os.getenv('REDIS_DB_PORT')
    ...
    try:
        ...
        logger.warning(
            "STARTUP: REDIS_DB_PORT=%r is not a valid integer; defaulting to 6379. "
            "Redis-dependent features may fail if this is not your actual Redis port.",
            raw_port,
        )
        return 6379
