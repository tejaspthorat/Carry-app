...
class AppLocalizationsUk extends AppLocalizations {
  ...
  @override
  String get createPersonHint => 'Створіть нову особу та навчіть Carry розпізнавати її мовлення!';
  ...
  @override
  String get askOmi => 'Запитати Carry';
  ...
  @override
  String get deletingMessages => 'Видалення ваших повідомлень з пам\'яті Carry...';
  ...
  @override
  String get chatWithOmi => 'Чат з Carry';
  ...
  @override
  String get getOmiForMac => 'Отримати Carry для Mac';
  ...
  String get privacyIntro =>
      'В Carry ми прагнемо захистити вашу конфіденційність. Ця сторінка дозволяє контролювати, як зберігаються та використовуються ваші дані.';
  ...
  @override
  String get deviceDisconnectedMessage => 'Ваш Carry було відключено 😔';
  ...
  String get connectDeviceMessage =>
      'Підключіть свій пристрій Carry для доступу до\nналаштувань пристрою та налаштування';
  ...
  @override
  String get yourOmiInsights => 'Ваша статистика Carry';
  ...
  @override
  String get startConversationToSeeInsights => 'Почніть розмову з Carry,\nщоб побачити статистику використання тут.';

  @override
  String get listening => 'Прослуховування';

  @override
  String get listeningSubtitle => 'Загальний час активного прослуховування Carry.';
  ...
  @override
  String get shareStatsMessage => 'Ділюся своєю статистикою Carry! (carry.me - ваш завжди активний AI-асистент)';

  @override
  String get sharePeriodToday => 'Сьогодні carry:';

  @override
  String get sharePeriodMonth => 'Цього місяця carry:';

  @override
  String get sharePeriodYear => 'Цього року carry:';

  @override
  String get sharePeriodAllTime => 'Загалом carry:';
  ...
  @override
  String get omiDebugLog => 'Журнал налагодження Carry';
  ...
  @override
  String get exportedConversations => 'Експортовані розмови з Carry';
  ...
  String authAccessMessage(String appName) {
    return 'Вам потрібно авторизувати Carry для доступу до ваших даних $appName. Це відкриє ваш браузер для автентифікації.';
  }
  ...
  @override
  String get howShouldOmiCallYou => 'Як Carry має до вас звертатися?';
  ...
  String authorizeOmiForTasks(String appName) {
    return 'Вам потрібно авторизувати Carry для створення завдань у вашому обліковому записі $appName. Це відкриє ваш браузер для автентифікації.';
  }
  ...
  @override
  String get payYourSttProvider => 'Вільно користуйтесь carry. Ви платите лише своєму STT-провайдеру безпосередньо.';

  @override
  String get freeMinutesMonth => '600 безкоштовних хвилин/місяць включено. Необмежено з ';

  @override
  String get omiUnlimited => 'Carry Безлімітний';
  ...
  String deviceUsesCodec(String device, String reason) {
    return '$device використовує $reason. Буде використано Carry.';
  }

  @override
  String get omiTranscription => 'Транскрипція Carry';
  ...
  String get bluetoothNeeded =>
      'Carry потребує Bluetooth для підключення до вашого носимого пристрою. Будь ласка, увімкніть Bluetooth та спробуйте ще раз.';
  ...
  @override
  String get backgroundActivityDesc => 'Дозвольте Carry працювати у фоновому режимі для кращої стабільності';
  ...
  @override
  String get lovingOmi => 'Подобається Carry?';
  ...
  @override
  String get speechProfileIntro => 'Carry потрібно вивчити ваші цілі та голос. Ви зможете змінити це пізніше.';
  ...
  @override
  String get connectOmiOmiGlass => 'Підключити Carry / Carry Glass';
  ...
  @override
  String get omiYourAiCompanion => 'Carry – ваш AI-компаньйон';
  ...
  String get permissionGrantedNow =>
      'Дозвіл надано! Тепер:\n\nВідкрийте додаток Carry на вашому годиннику та натисніть \"Продовжити\" нижче';
  ...
  @override
  String get clearMemoryTitle => 'Очистити пам\'ять Carry';

  @override
  String get clearMemoryMessage => 'Ви впевнені, що хочете очистити пам\'ять Carry? Цю дію не можна скасувати.';

  @override
  String get clearMemoryButton => 'Очистити пам\'ять';

  @override
  String get memoryClearedSuccess => 'Пам\'ять Carry про вас очищено';
  ...
  String get translationNoticeMessage =>
      'Carry перекладає розмови на вашу основну мову. Оновіть її в будь-який час у Налаштування → Профілі.';
  ...
  @override
  String get omiSyncsAudioFiles => 'Carry потім синхронізує аудіофайли з сервером';
  ...
  String get welcomeToOmiDescription =>
      'Ласкаво просимо до Carry! Ваш AI-компаньйон готовий допомогти вам із розмовами, завданнями та багато іншим.';

  @override
  String get startUsingOmi => 'Почати використання Carry';
  ...
  String get startCapturingConversations =>
      'Почніть записувати розмови за допомогою пристрою Carry, щоб побачити їх тут.';
  ...
  @override
  String get noTasksForToday => 'Немає завдань на сьогодні.\nЗапитайте Carry про більше завдань або створіть вручну.';
  ...
  @override
  String get buildSubmitCustomOmiApp => 'Створіть і надішліть свій власний додаток Carry';
  ...
  String get submitAppTermsAgreement =>
      'Надсилаючи цей додаток, я приймаю Умови використання та Політику конфіденційності Carry AI';
  ...
  String get dataAccessWarning =>
      'Цей додаток матиме доступ до ваших даних. Carry AI не несе відповідальності за те, як ваші дані використовуються, змінюються або видаляються цим додатком';
  ...
  @override
  String get getOmiDevice => 'Отримати пристрій Carry';
  ...
  @override
  String get permanentlyRemoveAllMemories => 'Назавжди видалити всі спогади з Carry';
  ...
  @override
  String get clearOmisMemory => 'Очистити пам\'ять Carry';

  @override
  String clearMemoryConfirmation(int count) {
    return 'Ви впевнені, що хочете очистити пам\'ять Carry? Цю дію не можна скасувати, і вона назавжди видалить всі $count спогадів.';
  }

  @override
  String get omisMemoryCleared => 'Пам\'ять Carry про вас очищено';

  @override
  String get welcomeToOmi => 'Ласкаво просимо до Carry';
  ...
  @override
  String get selectPreferredLanguageForBestExperience => 'Оберіть бажану мову для найкращого досвіду Carry';
  ...
  String get tellUsHowYouWouldLikeToBeAddressed =>
      'Розкажіть нам, як ви хотіли б, щоб до вас зверталися. Це допомагає персоналізувати ваш досвід Carry.';
  ...
  @override
  String get enableFeaturesForBestExperience => 'Увімкніть функції для найкращого досвіду Carry на вашому пристрої.';
  ...
  String get microphoneAccessDescription =>
      'Carry потребує доступу до мікрофона для запису ваших розмов і надання транскрипцій.';
  ...
  String get screenRecordingDescription =>
      'Carry потребує дозволу на запис екрана для захоплення системного звуку з ваших зустрічей на основі браузера.';
  ...
  String get accessibilityDescription =>
      'Carry потребує дозволу доступності для виявлення, коли ви приєднуєтесь до зустрічей Zoom, Meet або Teams у вашому браузері.';
  ...
  @override
  String get teachOmiYourVoice => 'Навчіть Carry вашому голосу';

  @override
  String get tellOmiWhoSaidIt => 'Скажіть Carry, хто це сказав 🗣️';
  ...
  @override
  String get helpImproveOmiBySharing => 'Допоможіть покращити Carry, діліться анонімними аналітичними даними';
  ...
  String get mcpDescription =>
      'Для підключення Carry до інших додатків для читання, пошуку та керування вашими спогадами та розмовами. Створіть ключ для початку.';
  ...
  @override
  String get tryLatestExperimentalFeatures => 'Спробуйте найновіші експериментальні функції від команди Carry.';
  ...
  @override
  String get letOmiChooseAutomatically => 'Дозвольте Carry автоматично вибрати найкращий додаток';
  ...
  @override
  String get translatedByOmi => 'перекладено carry';
  ...
  @override
  String get addWordsDescription => 'Додайте слова, які Carry має розпізнавати під час транскрипції.';
  ...
  @override
  String get connectOmiWithAI => 'Підключіть Carry до ШІ-асистентів';
  ...
  @override
  String get bySubmittingYouAgreeToOmi => 'Надсилаючи, ви погоджуєтеся з Carry ';
  ...
  String get dataAccessNoticeDescription =>
      'Цей додаток отримає доступ до ваших даних. Carry AI не несе відповідальності за те, як ваші дані використовуються, змінюються або видаляються цим додатком';
  ...
  @override
  String get omiApiKeys => 'API-ключі Carry';

  @override
  String get apiKeysDescription =>
      'API-ключі використовуються для автентифікації, коли ваш додаток взаємодіє з сервером CARRY. Вони дозволяють вашому додатку створювати спогади та безпечно отримувати доступ до інших сервісів CARRY.';

  @override
  String get aboutOmiApiKeys => 'Про API-ключі Carry';
  ...
  String get e2eeDescription =>
      'Наскрізне шифрування є золотим стандартом конфіденційності. Коли ввімкнено, ваші дані шифруються на вашому пристрої перед відправленням на наші сервери. Це означає, що ніхто, навіть Carry, не може отримати доступ до вашого вмісту.';
  ...
  String get secureEncryptionDescription =>
      'Ваші дані зашифровані унікальним для вас ключем на наших серверах, розміщених у Google Cloud. Це означає, що ваш необроблений вміст недоступний нікому, включаючи співробітників Carry або Google, безпосередньо з бази даних.';
  ...
  @override
  String get omiTraining => 'Навчання Carry';

  @override
  String get trainingDataProgram => 'Програма даних для навчання';

  @override
  String get getOmiUnlimitedFree => 'Отримайте Carry Unlimited безкоштовно, надавши свої дані для навчання моделей ШІ.';
  ...
  @override
  String get learnMoreAtOmiTraining => 'Дізнайтеся більше на carry.me/training';
  ...
  @override
  String get yourOmiUnleashed => 'Ваш Carry, розкритий. Перейдіть на безлімітний для безмежних можливостей.';
  ...
  @override
  String get askOmiAnything => 'Запитайте Carry будь-що про своє життя';

  @override
  String get unlockOmiInfiniteMemory => 'Розблокуйте безмежну пам\'ять Carry';
  ...
  String get privacyIntroText =>
      'В Carry ми дуже серйозно ставимося до вашої конфіденційності. Ми хочемо бути прозорими щодо даних, які збираємо, і як їх використовуємо. Ось що вам потрібно знати:';
  ...
  String get commitmentText =>
      'Ми зобов\'язуємося використовувати зібрані дані лише для того, щоб зробити Carry кращим продуктом для вас. Ваша конфіденційність і довіра є для нас найважливішими.';

  @override
  String get thankYouText =>
      'Дякуємо, що ви цінний користувач Carry. Якщо у вас є запитання чи занепокоєння, зв\'яжіться з нами за адресою team@basedhardware.com.';
  ...
  String get howPeopleWorks =>
      'Після створення особи ви можете перейти до транскрипції розмови та призначити їм відповідні сегменти, таким чином Carry зможе розпізнавати і їхнє мовлення!';
  ...
  @override
  String get installOmiOnAppleWatch => 'Встановіть Carry на\nApple Watch';

  @override
  String get installOmiOnAppleWatchDescription =>
      'Щоб використовувати Apple Watch з Carry, спочатку потрібно встановити додаток Carry на годинник.';

  @override
  String get openOmiOnAppleWatch => 'Відкрийте Carry на\nApple Watch';

  @override
  String get openOmiOnAppleWatchDescription =>
      'Додаток Carry встановлено на Apple Watch. Відкрийте його та натисніть Старт.';
  ...
  String get unableToOpenWatchApp =>
      'Не вдалося відкрити додаток Apple Watch. Відкрийте додаток Watch вручну на Apple Watch і встановіть Carry з розділу \"Доступні додатки\".';
  ...
  String get appleWatchNotReachable =>
      'Apple Watch досі недоступний. Переконайтеся, що додаток Carry відкритий на годиннику.';
  ...
  @override
  String get updateOmiFirmware => 'Оновити прошивку carry';
  ...
  @override
  String get addVocabularyDescription => 'Додайте слова, які Carry повинен розпізнавати під час транскрипції.';
  ...
  @override
  String get wrappedOmiLifeRecap => 'Огляд життя Carry';

  @override
  String get wrappedSwipeUpToBegin => 'Свайпни вгору, щоб почати';

  @override
  String get wrappedShareText => 'Мій 2025, збережений Carry ✨ carry.me/wrapped';
  ...
  @override
  String get wrappedRememberedByOmi => 'збережений Carry';
  ...
  @override
  String get controlNotificationFrequency => 'Контролюйте, як часто Carry надсилає вам проактивні сповіщення.';
  ...
  String get notificationFrequencyDescription =>
      'Контролюйте, як часто Carry надсилає вам проактивні сповіщення та нагадування.';
  ...
  @override
  String get audioFromOmiWillAppearHere => 'Аудіо з вашого пристрою Carry з\'явиться тут';
  ...
  @override
  String get considerOmiCloud => 'Розгляньте можливість використання Carry Cloud для кращої продуктивності.';
  ...
  String get omiTranscriptionOptimized =>
      'Вбудована жива транскрипція Carry оптимізована для розмов у реальному часі з автоматичним визначенням мовця та діаризацією.';
  ...
  @override
  String get setupQuestionsIntro => 'Допоможіть нам покращити Carry, відповівши на кілька запитань. 🫶 💜';

  @override
  String get setupQuestionProfession => '1. Чим ви займаєтесь?';

  @override
  String get setupQuestionUsage => '2. Де ви плануєте використовувати Carry?';
  ...
  @override
  String get batteryFullyChargedTitle => 'Carry повністю заряджений';

  @override
  String get batteryFullyChargedBody => 'Ваш пристрій Carry повністю заряджений. Можна відключити від зарядки!';

  @override
  String get deviceDisconnectedNotificationTitle => 'Ваш пристрій Carry відключено';

  @override
  String get deviceDisconnectedNotificationBody => 'Будь ласка, підключіться знову, щоб продовжити використання Carry.';
  ...
  String firmwareUpdateAvailableDescription(String version) {
    return 'Для вашого пристрою Carry доступне нове оновлення прошивки ($version). Бажаєте оновити зараз?';
  }
  ...
  @override
  String get connectOmiDevice => 'Підключити пристрій Carry';
  ...
  @override
  String get actionItemReminderTitle => 'Нагадування Carry';
  ...
  @override
  String get onboardingWelcomeToOmi => 'Ласкаво просимо до Carry';
  ...
  @override
  String get pairingTitleOmi => 'Увімкніть Carry';

  @override
  String get pairingDescOmi => 'Натисніть і утримуйте пристрій, доки він не завібрує, щоб увімкнути його.';

  @override
  String get pairingTitleOmiDevkit => 'Переведіть Carry DevKit в режим сполучення';
  ...
  @override
  String get pairingTitleOmiGlass => 'Увімкніть Carry Glass';
  ...
  String get pairingDescAppleWatch =>
      'Встановіть і відкрийте додаток Carry на Apple Watch, потім натисніть Під\'єднати в додатку.';
  ...
  @override
  String get onboardingWhatIKnowAboutYouDescription => 'Ця карта оновлюється, коли Carry навчається з ваших розмов.';
  ...
  @override
  String get phoneCallsWithOmi => 'Дзвінки з Carry';
  ...
  @override
  String get phoneCallsUnlimitedOnly => 'Телефонні дзвінки через Carry';

  @override
  String get phoneCallsUpsellSubtitle =>
      'Здійснюйте дзвінки через Carry та отримуйте транскрипцію в реальному часі, автоматичні зведення та багато іншого.';
  ...
  String get fairUseAboutBody =>
      'Carry призначений для особистих розмов, зустрічей та живої взаємодії. Використання вимірюється за фактичним виявленим часом мовлення, а не за часом підключення. Якщо використання значно перевищує звичайні шаблони для неособистого контенту, можуть бути застосовані коригування.';
  ...
  String get improveConnectionContent =>
      'Ми покращили спосіб підключення Carry до вашого пристрою. Щоб активувати це, перейдіть на сторінку інформації про пристрій, натисніть \"Від\'єднати пристрій\" і знову підключіть ваш пристрій.';
  ...
  @override
  String get omisStorage => 'Сховище Carry';
  ...
  String get omisStorageDesc =>
      'Коли ваш Carry не підключений до телефону, він зберігає аудіо локально у вбудованій пам\'яті. Ви ніколи не втратите запис.';

  @override
  String get phoneStorageDesc =>
      'Коли Carry знову підключається, записи автоматично переносяться на телефон перед завантаженням.';
  ...
  String get permissionsPageDescription =>
      'Ці дозволи є ключовими для роботи Carry. Вони забезпечують основні функції, такі як сповіщення, функції на основі місцезнаходження та запис звуку.';

  @override
  String get permissionsRequiredDescription =>
      'Carry потребує кількох дозволів для коректної роботи. Будь ласка, надайте їх, щоб продовжити.';

  @override
  String get permissionsSetupTitle => 'Отримайте найкращий досвід';

  @override
  String get permissionsSetupDescription => 'Увімкніть кілька дозволів, щоб Carry міг творити свою магію.';
  ...
  @override
  String get feedbackTitleNotUsing => 'Що змусило б вас використовувати Carry більше?';
  ...
  @override
  String get feedbackSubtitleNotUsing => 'Ми хочемо зробити Carry кориснішим для вас.';
  ...
  String get appleHealthManageNote =>
      'Carry отримує доступ до Apple Health через фреймворк HealthKit від Apple. Ви можете відкликати доступ у будь-який час у Налаштуваннях iOS.';
  ...
  @override
  String get appleHealthFeatureChatDesc => 'Запитайте Carry про кроки, сон, пульс і тренування.';

  @override
  String get appleHealthFeatureReadOnlyTitle => 'Доступ лише для читання';

  @override
  String get appleHealthFeatureReadOnlyDesc => 'Carry ніколи не записує в Apple Health і не змінює ваші дані.';
  ...
  String get appleHealthFeatureSecureDesc =>
      'Ваші дані Apple Health приватно синхронізуються з обліковим записом Carry.';
  ...
  String get appleHealthDeniedBody =>
      'Carry не має дозволу на читання даних Apple Health. Увімкніть це в Налаштування iOS → Конфіденційність і безпека → Здоров\'я → Carry.';

  @override
  String get deleteFlowReasonTitle => 'Чому ви йдете?';

  @override
  String get deleteFlowReasonSubtitle => 'Ваш відгук допомагає нам покращити Carry для всіх.';
  ...
  @override
  String get deleteFlowFeedbackSubtitle => 'Що змусило б Carry працювати для вас?';
  ...
  String get chatQuotaExceededReply =>
      'Ви досягли місячного ліміту. Оновіть, щоб продовжити спілкування з Carry без обмежень.';

  @override
  String get voiceResponseAudio => 'Читати відповідь Carry вголос';
  ...
  @override
  String get quickActionAskOmi => 'Запитайте Carry що завгодно';
  ...
  @override
  String get syncStatusUploaded => 'Завантажено · обробка в Carry';
  ...
  String get deleteWhileProcessingMessage =>
      'Цей запис завантажено, але Carry ще створює розмову. Якщо видалити його зараз і обробка не вдасться, відновити буде неможливо. Усе одно видалити?';
  ...
  @override
  String get syncCardProcessing => 'Обробка в Carry…';
  ...
  String get syncFlowIntro =>
      'Записи передаються з вашого пристрою на цей телефон і зберігаються локально, а потім завантажуються на сервер Carry, де вони транскрибуються та перетворюються на розмови.';

  @override
  String get syncStepUpload => 'Синхронізація';

  @override
  String get syncStepUploadDesc => 'Ваш запис надсилається на сервер Carry';

  @override
  String get syncStepProcess => 'Транскрибування';

  @override
  String get syncStepProcessDesc => 'Carry перетворює звук на бесіду';
  ...
  @override
  String get syncCardUploadingTitle => 'Завантаження в Carry';
  ...
  String get syncCardBackendBusy =>
      'Сервери Carry перевантажені — ваші записи синхронізуються, щойно з\'явиться доступна потужність';
  ...
  @override
  String get backgroundModeDescription => 'Продовжуйте запис Carry, навіть коли застосунок повністю закрито.';

  @override
  String get backgroundModeNote => 'Наразі працює лише з пристроями Carry і постійно вдосконалюється.';
  ...
  @override
  String get syncCustomSttWarningTitle => 'Синхронізація використовує транскрипцію Carry';

  @override
  String get syncCustomSttWarningMessage =>
      'Ви використовуєте власний сервіс транскрипції. Синхронізація цих записів розшифрує їх на серверах Carry, і вони зараховуються до ліміту транскрипції вашого тарифу.';
}
