...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get createPersonHint => 'Создайте нового человека и обучите Carry распознавать его голос тоже!';
  ...
  @override
  String get askOmi => 'Спросить Carry';
  ...
  @override
  String get deletingMessages => 'Удаление ваших сообщений из памяти Carry...';
  ...
  @override
  String get getOmiForMac => 'Получить Carry для Mac';
  ...
  String get privacyIntro =>
      'В Carry мы стремимся защитить вашу конфиденциальность. Эта страница позволяет вам контролировать, как хранятся и используются ваши данные.';
  ...
  @override
  String get deviceDisconnectedMessage => 'Ваш Carry был отключён 😔';
  ...
  @override
  String get connectDeviceMessage => 'Подключите устройство Carry для доступа\nк настройкам устройства и настройке';
  ...
  String get startConversationToSeeInsights =>
      'Начните разговор с Carry,\nчтобы увидеть здесь вашу статистику использования.';

  @override
  String get listening => 'Прослушивание';

  @override
  String get listeningSubtitle => 'Общее время активного прослушивания Carry.';
  ...
  @override
  String get shareStatsMessage => 'Делюсь статистикой Carry! (carry.me - ваш постоянный AI-помощник)';

  @override
  String get sharePeriodToday => 'Сегодня carry:';

  @override
  String get sharePeriodMonth => 'В этом месяце carry:';

  @override
  String get sharePeriodYear => 'В этом году carry:';

  @override
  String get sharePeriodAllTime => 'За всё время carry:';
  ...
  @override
  String get omiDebugLog => 'Журнал отладки Carry';
  ...
  @override
  String get exportedConversations => 'Экспортированные разговоры из Carry';
  ...
  String authAccessMessage(String appName) {
    return 'Вам нужно авторизовать Carry для доступа к вашим данным $appName. Это откроет браузер для аутентификации.';
  }
  ...
  @override
  String get howShouldOmiCallYou => 'Как Carry должен вас называть?';
  ...
  String authorizeOmiForTasks(String appName) {
    return 'Вам нужно авторизовать Carry для создания задач в вашем аккаунте $appName. Это откроет браузер для аутентификации.';
  }
  ...
  @override
  String get payYourSttProvider => 'Свободно используйте carry. Вы платите только своему провайдеру STT напрямую.';
  ...
  String deviceUsesCodec(String device, String reason) {
    return '$device использует $reason. Будет использован Carry.';
  }

  @override
  String get omiTranscription => 'Расшифровка Carry';
  ...
  String get bluetoothNeeded =>
      'Carry требуется Bluetooth для подключения к вашему устройству. Пожалуйста, включите Bluetooth и попробуйте снова.';
  ...
  @override
  String get backgroundActivityDesc => 'Позвольте Carry работать в фоновом режиме для лучшей стабильности';
  ...
  @override
  String get lovingOmi => 'Нравится Carry?';
  ...
  @override
  String get speechProfileIntro => 'Carry нужно узнать ваши цели и ваш голос. Вы сможете изменить это позже.';
  ...
  @override
  String get connectOmiOmiGlass => 'Подключить Carry / Carry Glass';
  ...
  @override
  String get omiYourAiCompanion => 'Carry – ваш AI-компаньон';
  ...
  String get permissionGrantedNow =>
      'Разрешение предоставлено! Теперь:\n\nОткройте приложение Carry на ваших часах и нажмите \"Продолжить\" ниже';
  ...
  @override
  String get clearMemoryTitle => 'Очистить память Carry';

  @override
  String get clearMemoryMessage => 'Вы уверены, что хотите очистить память Carry? Это действие нельзя отменить.';

  @override
  String get clearMemoryButton => 'Очистить память';

  @override
  String get memoryClearedSuccess => 'Память Carry о вас была очищена';
  ...
  String get translationNoticeMessage =>
      'Carry переводит разговоры на ваш основной язык. Обновите его в любое время в Настройки → Профили.';
  ...
  @override
  String get omiSyncsAudioFiles => 'Carry затем синхронизирует аудиофайлы с сервером';
  ...
  String get welcomeToOmiDescription =>
      'Добро пожаловать в Carry! Ваш AI-компаньон готов помочь вам с разговорами, задачами и многим другим.';

  @override
  String get startUsingOmi => 'Начать использовать Carry';
  ...
  String get startCapturingConversations =>
      'Начните записывать разговоры с помощью устройства Carry, чтобы увидеть их здесь.';
  ...
  @override
  String get noTasksForToday => 'Нет задач на сегодня.\nСпросите Carry о дополнительных задачах или создайте вручную.';
  ...
  @override
  String get buildSubmitCustomOmiApp => 'Создайте и отправьте свое пользовательское приложение Carry';
  ...
  String get submitAppTermsAgreement =>
      'Отправляя это приложение, я принимаю Условия использования и Политику конфиденциальности Carry AI';
  ...
  String get dataAccessWarning =>
      'Это приложение получит доступ к вашим данным. Carry AI не несет ответственности за то, как ваши данные используются, изменяются или удаляются этим приложением';
  ...
  @override
  String get getOmiDevice => 'Получить устройство Carry';
  ...
  @override
  String get permanentlyRemoveAllMemories => 'Навсегда удалить все воспоминания из Carry';
  ...
  @override
  String get clearOmisMemory => 'Очистить память Carry';

  @override
  String clearMemoryConfirmation(int count) {
    return 'Вы уверены, что хотите очистить память Carry? Это действие нельзя отменить, и оно навсегда удалит все $count воспоминаний.';
  }

  @override
  String get omisMemoryCleared => 'Память Carry о вас была очищена';

  @override
  String get welcomeToOmi => 'Добро пожаловать в Carry';
  ...
  @override
  String get selectPreferredLanguageForBestExperience => 'Выберите предпочитаемый язык для наилучшего опыта Carry';
  ...
  String get tellUsHowYouWouldLikeToBeAddressed =>
      'Скажите нам, как вы хотели бы, чтобы к вам обращались. Это помогает персонализировать ваш опыт Carry.';
  ...
  @override
  String get enableFeaturesForBestExperience => 'Включите функции для наилучшего опыта Carry на вашем устройстве.';
  ...
  String get microphoneAccessDescription =>
      'Carry нужен доступ к микрофону для записи ваших разговоров и предоставления транскрипций.';
  ...
  String get screenRecordingDescription =>
      'Carry нужно разрешение на запись экрана для захвата системного звука с ваших встреч на базе браузера.';
  ...
  String get accessibilityDescription =>
      'Carry нужно разрешение доступности для обнаружения, когда вы присоединяетесь к встречам Zoom, Meet или Teams в вашем браузере.';
  ...
  @override
  String get teachOmiYourVoice => 'Научите Carry вашему голосу';

  @override
  String get tellOmiWhoSaidIt => 'Скажите Carry, кто это сказал 🗣️';
  ...
  @override
  String get helpImproveOmiBySharing => 'Помогите улучшить Carry, делясь анонимными аналитическими данными';
  ...
  String get mcpDescription =>
      'Для подключения Carry к другим приложениям для чтения, поиска и управления вашими воспоминаниями и беседами. Создайте ключ для начала.';
  ...
  @override
  String get tryLatestExperimentalFeatures => 'Попробуйте новейшие экспериментальные функции от команды Carry.';
  ...
  @override
  String get letOmiChooseAutomatically => 'Позвольте Carry автоматически выбрать лучшее приложение';
  ...
  @override
  String get translatedByOmi => 'переведено carry';
  ...
  @override
  String get addWordsDescription => 'Добавьте слова, которые Carry должен распознавать во время транскрипции.';
  ...
  @override
  String get connectOmiWithAI => 'Подключите Carry к ИИ-ассистентам';
  ...
  @override
  String get omiApiKeys => 'API-ключи Carry';

  @override
  String get apiKeysDescription =>
      'API-ключи используются для аутентификации, когда ваше приложение взаимодействует с сервером CARRY. Они позволяют вашему приложению создавать воспоминания и безопасно получать доступ к другим сервисам CARRY.';

  @override
  String get aboutOmiApiKeys => 'Об API-ключах Carry';
  ...
  String get e2eeDescription =>
      'Сквозное шифрование — это золотой стандарт конфиденциальности. При включении ваши данные шифруются на вашем устройстве перед отправкой на наши серверы. Это означает, что никто, даже Carry, не может получить доступ к вашему контенту.';
  ...
  String get secureEncryptionDescription =>
      'Ваши данные шифруются уникальным для вас ключом на наших серверах, размещенных в Google Cloud. Это означает, что ваш необработанный контент недоступен никому, включая сотрудников Carry или Google, напрямую из базы данных.';
  ...
  @override
  String get omiTraining => 'Обучение Carry';
  ...
  String get getOmiUnlimitedFree =>
      'Получите Carry Unlimited бесплатно, предоставив свои данные для обучения моделей ИИ.';
  ...
  @override
  String get learnMoreAtOmiTraining => 'Узнайте больше на carry.me/training';
  ...
  @override
  String get yourOmiUnleashed => 'Ваш Carry, раскрытый. Перейдите на безлимит для бесконечных возможностей.';
  ...
  @override
  String get askOmiAnything => 'Спросите Carry о чём угодно о своей жизни';

  @override
  String get unlockOmiInfiniteMemory => 'Разблокируйте бесконечную память Carry';
  ...
  String get privacyIntroText =>
      'В Carry мы очень серьезно относимся к вашей конфиденциальности. Мы хотим быть прозрачными в отношении собираемых данных и их использования. Вот что вам нужно знать:';
  ...
  String get commitmentText =>
      'Мы обязуемся использовать собранные данные только для улучшения Carry для вас. Ваша конфиденциальность и доверие имеют для нас первостепенное значение.';

  @override
  String get thankYouText =>
      'Спасибо, что вы ценный пользователь Carry. Если у вас есть вопросы или проблемы, свяжитесь с нами по адресу team@basedhardware.com.';
  ...
  String get howPeopleWorks =>
      'После создания человека вы можете перейти к расшифровке разговора и назначить ему соответствующие сегменты, тогда Carry сможет распознавать и его речь!';
  ...
  @override
  String get installOmiOnAppleWatch => 'Установите Carry на\nApple Watch';

  @override
  String get installOmiOnAppleWatchDescription =>
      'Чтобы использовать Apple Watch с Carry, сначала необходимо установить приложение Carry на часы.';

  @override
  String get openOmiOnAppleWatch => 'Откройте Carry на\nApple Watch';

  @override
  String get openOmiOnAppleWatchDescription =>
      'Приложение Carry установлено на Apple Watch. Откройте его и нажмите Старт.';
  ...
  String get unableToOpenWatchApp =>
      'Не удалось открыть приложение Apple Watch. Откройте приложение Watch вручную на Apple Watch и установите Carry из раздела \"Доступные приложения\".';
  ...
  String get appleWatchNotReachable =>
      'Apple Watch все еще недоступны. Убедитесь, что приложение Carry открыто на часах.';
  ...
  @override
  String get updateOmiFirmware => 'Обновить прошивку carry';
  ...
  @override
  String get addVocabularyDescription => 'Добавьте слова, которые Carry должен распознавать при транскрипции.';
  ...
  @override
  String get wrappedOmiLifeRecap => 'Обзор жизни Carry';

  @override
  String get wrappedSwipeUpToBegin => 'Свайпни вверх, чтобы начать';

  @override
  String get wrappedShareText => 'Мой 2025, сохранённый Carry ✨ carry.me/wrapped';
  ...
  @override
  String get wrappedRememberedByOmi => 'сохранённый Carry';
  ...
  @override
  String get controlNotificationFrequency => 'Управляйте частотой отправки проактивных уведомлений от Carry.';
  ...
  String get notificationFrequencyDescription =>
      'Управляйте тем, как часто Carry отправляет вам проактивные уведомления и напоминания.';
  ...
  @override
  String get audioFromOmiWillAppearHere => 'Аудио с вашего устройства Carry появится здесь';
  ...
  @override
  String get considerOmiCloud => 'Рассмотрите использование Carry Cloud для лучшей производительности.';
  ...
  String get omiTranscriptionOptimized =>
      'Встроенная живая транскрипция Carry оптимизирована для разговоров в реальном времени с автоматическим определением говорящего и диаризацией.';
  ...
  @override
  String get setupQuestionsIntro => 'Помогите нам улучшить Carry, ответив на несколько вопросов. 🫶 💜';

  @override
  String get setupQuestionProfession => '1. Чем вы занимаетесь?';

  @override
  String get setupQuestionUsage => '2. Где вы планируете использовать Carry?';
  ...
  @override
  String get batteryFullyChargedTitle => 'Carry полностью заряжен';

  @override
  String get batteryFullyChargedBody => 'Ваше устройство Carry полностью заряжено. Можно отключить от зарядки!';

  @override
  String get deviceDisconnectedNotificationTitle => 'Ваше устройство Carry отключено';

  @override
  String get deviceDisconnectedNotificationBody =>
      'Пожалуйста, подключитесь снова, чтобы продолжить использование Carry.';
  ...
  String firmwareUpdateAvailableDescription(String version) {
    return 'Для вашего устройства Carry доступно новое обновление прошивки ($version). Хотите обновить сейчас?';
  }
  ...
  @override
  String get omiSays => 'carry говорит';
  ...
  @override
  String get connectOmiDevice => 'Подключить устройство Carry';
  ...
  @override
  String get actionItemReminderTitle => 'Напоминание Carry';
  ...
  @override
  String get onboardingWelcomeToOmi => 'Добро пожаловать в Carry';
  ...
  @override
  String get pairingTitleOmi => 'Включите Carry';

  @override
  String get pairingDescOmi => 'Нажмите и удерживайте устройство, пока оно не завибрирует, чтобы включить его.';

  @override
  String get pairingTitleOmiDevkit => 'Переведите Carry DevKit в режим сопряжения';
  ...
  @override
  String get pairingTitleOmiGlass => 'Включите Carry Glass';
  ...
  String get pairingDescAppleWatch =>
      'Установите и откройте приложение Carry на Apple Watch, затем нажмите Подключить в приложении.';
  ...
  String get onboardingWhatIKnowAboutYouDescription =>
      'Эта карта обновляется по мере того, как Carry учится на ваших разговорах.';
  ...
  @override
  String get phoneCallsWithOmi => 'Звонки с Carry';
  ...
  @override
  String get phoneCallsUnlimitedOnly => 'Звонки через Carry';

  @override
  String get phoneCallsUpsellSubtitle =>
      'Совершайте звонки через Carry и получайте транскрипцию в реальном времени, автоматические сводки и многое другое.';
  ...
  String get fairUseAboutBody =>
      'Carry предназначен для личных разговоров, встреч и живого общения. Использование измеряется по фактическому обнаруженному времени речи, а не по времени подключения. Если использование значительно превышает обычные модели для неличного контента, могут применяться корректировки.';
  ...
  String get improveConnectionContent =>
      'Мы улучшили способ подключения Carry к вашему устройству. Чтобы активировать это, перейдите на страницу информации об устройстве, нажмите \"Отключить устройство\" и снова подключите ваше устройство.';
  ...
  @override
  String get omisStorage => 'Хранилище Carry';
  ...
  String get omisStorageDesc =>
      'Когда ваш Carry не подключён к телефону, он сохраняет аудио локально во встроенной памяти. Вы никогда не потеряете запись.';

  @override
  String get phoneStorageDesc =>
      'При повторном подключении Carry записи автоматически переносятся на телефон перед загрузкой.';
  ...
  String get permissionsPageDescription =>
      'Эти разрешения необходимы для работы Carry. Они обеспечивают ключевые функции, такие как уведомления, функции на основе местоположения и запись звука.';

  @override
  String get permissionsRequiredDescription =>
      'Carry нужны некоторые разрешения для правильной работы. Пожалуйста, предоставьте их, чтобы продолжить.';

  @override
  String get permissionsSetupTitle => 'Получите лучший опыт';

  @override
  String get permissionsSetupDescription => 'Включите несколько разрешений, чтобы Carry мог творить свою магию.';
  ...
  @override
  String get feedbackTitleNotUsing => 'Что заставило бы вас использовать Carry больше?';
  ...
  @override
  String get feedbackSubtitleNotUsing => 'Мы хотим сделать Carry более полезным для вас.';
  ...
  String get appleHealthManageNote =>
      'Carry получает доступ к Apple Health через фреймворк HealthKit от Apple. Вы можете отозвать доступ в любой момент в Настройках iOS.';
  ...
  @override
  String get appleHealthFeatureChatDesc => 'Спрашивайте Carry о ваших шагах, сне, пульсе и тренировках.';

  @override
  String get appleHealthFeatureReadOnlyTitle => 'Доступ только для чтения';

  @override
  String get appleHealthFeatureReadOnlyDesc => 'Carry никогда не записывает в Apple Health и не изменяет ваши данные.';

  @override
  String get appleHealthFeatureSecureTitle => 'Безопасная синхронизация';

  @override
  String get appleHealthFeatureSecureDesc => 'Данные Apple Health приватно синхронизируются с вашим аккаунтом Carry.';
  ...
  String get appleHealthDeniedBody =>
      'У Carry нет разрешения на чтение данных Apple Health. Включите его в Настройках iOS → Конфиденциальность и безопасность → Здоровье → Carry.';

  @override
  String get deleteFlowReasonTitle => 'Почему вы уходите?';

  @override
  String get deleteFlowReasonSubtitle => 'Ваш отзыв помогает нам делать Carry лучше для всех.';
  ...
  @override
  String get deleteFlowFeedbackSubtitle => 'Что бы заставило Carry работать для вас?';
  ...
  String get chatQuotaExceededReply =>
      'Вы достигли месячного лимита. Обновите план, чтобы продолжить общение с Carry без ограничений.';

  @override
  String get voiceResponseAudio => 'Читать ответ Carry вслух';
  ...
  @override
  String get quickActionAskOmi => 'Спросите Carry что угодно';
  ...
  @override
  String get syncStatusUploaded => 'Загружено · обработка в Carry';
  ...
  String get deleteWhileProcessingMessage =>
      'Эта запись загружена, но Carry ещё создаёт разговор. Если удалить её сейчас и обработка не удастся, восстановить будет невозможно. Всё равно удалить?';
  ...
  String get syncFlowIntro =>
      'Записи передаются с вашего устройства на этот телефон и хранятся локально, а затем загружаются на сервер Carry, где они расшифровываются и превращаются в разговоры.';

  @override
  String get syncStepUpload => 'Синхронизация';

  @override
  String get syncStepUploadDesc => 'Ваша запись отправляется на сервер Carry';

  @override
  String get syncStepProcess => 'Расшифровка';

  @override
  String get syncStepProcessDesc => 'Carry превращает аудио в беседу';
  ...
  @override
  String get syncCardUploadingTitle => 'Загрузка в Carry';
  ...
  String get syncCardBackendBusy =>
      'Серверы Carry загружены — ваши записи синхронизируются, как только освободятся мощности';
  ...
  @override
  String get backgroundModeDescription => 'Продолжайте запись Carry, даже когда приложение полностью закрыто.';

  @override
  String get backgroundModeNote => 'Пока работает только с устройствами Carry и постоянно улучшается.';
  ...
  @override
  String get syncCustomSttWarningTitle => 'Синхронизация использует транскрипцию Carry';

  @override
  String get syncCustomSttWarningMessage =>
      'Вы используете собственный сервис транскрипции. Синхронизация этих записей расшифрует их на серверах Carry, и они будут засчитаны в лимит транскрипции вашего тарифа.';
}
