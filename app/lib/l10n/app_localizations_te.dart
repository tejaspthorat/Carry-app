...
class AppLocalizationsTe extends AppLocalizations {
  ...
  String get createPersonHint =>
      'కొత్త వ్యక్తిని సృష్టించండి మరియు వారి ఉపన్యాసాన్ని గుర్తించడానికి Carryని శిక్షణ ఇవ్వండి!';
  ...
  @override
  String get askOmi => 'Carryని అడగండి';
  ...
  @override
  String get deletingMessages => 'Carryના జ్ఞాపకం నుండి మీ సందేశాలను తొలగిస్తోంది...';
  ...
  @override
  String get chatWithOmi => 'Carryతో చ్యాట్ చేయండి';
  ...
  @override
  String get aboutOmi => 'Carryని గురించి';
  ...
  @override
  String get getOmiForMac => 'Mac కోసం Carry పొందండి';
  ...
  String get privacyIntro =>
      'Carryలో, మేము మీ గోప్యతను రక్షించడానికి ప్రతిబద్ధులు. ఈ పేజీ మీ డేటా ఎలా నిల్వ చేయబడుతుందో మరియు ఎలా ఉపయోగించబడుతుందో నియంత్రించడానికి మిమ్మల్ని అనుమతిస్తుంది.';
  ...
  @override
  String get deviceDisconnectedMessage => 'మీ Carry డిస్‌కనెక్ట్ చేయబడింది 😔';
  ...
  String get connectDeviceMessage =>
      'ఆచిన సెట్టింగ్‌లు మరియు ఆచిన సెట్టింగ్‌లను యాక్సెస్ చేయడానికి మీ Carry ডివైస్‌ను కనెక్ట్ చేయండి';
  ...
  @override
  String get yourOmiInsights => 'మీ Carry అంతర్దృష్టులు';
  ...
  String get startConversationToSeeInsights =>
      'మీ ఉపయోగ అంతర్దృష్టులను ఇక్కడ చూడటానికి Carryతో సంభాషణను ప్రారంభించండి.';

  @override
  String get listening => 'వినుట';

  @override
  String get listeningSubtitle => 'Carry సక్రియంగా వినిన మొత్తం సమయం.';
  ...
  @override
  String get shareStatsMessage => 'నా Carry గణాంకాలు భాగస్వామ్యం చేస్తోంది! (carry.me - మీ ఎల్లప్పుడు ఆన్ AI సహాయకుడు)';

  @override
  String get sharePeriodToday => 'ఈ రోజు, carry చేసింది:';

  @override
  String get sharePeriodMonth => 'ఈ నెల, carry చేసింది:';

  @override
  String get sharePeriodYear => 'ఈ సంవత్సరం, carry చేసింది:';

  @override
  String get sharePeriodAllTime => 'ఇప్పటి వరకు, carry చేసింది:';
  ...
  @override
  String get omiDebugLog => 'Carry డీబగ్ లాగ్';
  ...
  @override
  String get exportedConversations => 'Carryలో నిర్గమం చేసిన సంభాషణలు';
  ...
  String authAccessMessage(String appName) {
    return 'మీరు Carryని $appName డేటాను యాక్సెస్ చేయడానికి అధికరించాలి. ఇది ప్రామాణీకరణ కోసం మీ బ్రౌజర్‌ను తెరుస్తుంది.';
  }
  ...
  @override
  String get howShouldOmiCallYou => 'Carry మిమ్మల్ని ఎలా పిలవాలి?';
  ...
  String authorizeOmiForTasks(String appName) {
    return 'Carry మీ $appName ఖాతాలో టాస్క్‌లను సృష్టించడానికి ఆధికారం ఇవ్వాలి. ఇది ఆధికారం కోసం మీ బ్రౌజర్‌ను తెరుస్తుంది.';
  }
  ...
  @override
  String get payYourSttProvider => 'Carry ను స్వేచ్ఛగా ఉపయోగించండి. మీరు మీ STT ప్రదాతకు నేరుగా చెల్లించండి.';

  @override
  String get freeMinutesMonth => '600 ఉచిత నిమిషాలు/నెల చేర్చబడ్డాయి. అসীమితమైన ';

  @override
  String get omiUnlimited => 'Carry అసీమితం';
  ...
  String deviceUsesCodec(String device, String reason) {
    return '$device $reason ఉపయోగిస్తుంది. Carry ఉపయోగించబడుతుంది.';
  }

  @override
  String get omiTranscription => 'Carry ట్రాన్‌స్క్రిప్షన్';
  ...
  String get bluetoothNeeded =>
      'మీ ధరించదగిన పరికరానికి కనెక్ట్ చేయడానికి Carry కు బ్లూటూత్ అవసరం. దయచేసి బ్లూటూత్‌ను ప్రారంభించి మళ్లీ ప్రయత్నించండి.';
  ...
  @override
  String get backgroundActivityDesc => 'Carry ను మెరుగైన స్థిరత్వ కోసం నేపథ్యంలో నడవనివ్వండి';
  ...
  @override
  String get lovingOmi => 'Carry ని ఇష్టపడుతున్నారా?';
  ...
  @override
  String get speechProfileIntro => 'Carry మీ లక్ష్యాలు మరియు మీ గతిని నేర్చుకోవాలి. మీరు దీన్ని తరువాత సవరించగలరు.';
  ...
  @override
  String get connectOmiOmiGlass => 'Carry / Carry Glass కు కనెక్ట్ చేయండి';
  ...
  @override
  String get omiYourAiCompanion => 'Carry – మీ AI సహచరి';
  ...
  String get permissionGrantedNow =>
      'అనుమతి ఇవ్వబడింది! ఇప్పుడు:\n\nమీ గడియారంపై Carry అనువర్తనాన్ని తెరిచి దిగువ \"కొనసాగించండి\" ని నొక్కండి';
  ...
  @override
  String get clearMemoryTitle => 'Carry యొక్క జ్ఞాపకాన్ని సరిచేయండి';

  @override
  String get clearMemoryMessage => 'మీరు Carry యొక్క జ్ఞాపకాన్ని సరిచేయాలని నిర్ణయం చేసారా? ఈ చర్య చేయబడదు.';

  @override
  String get clearMemoryButton => 'జ్ఞాపకాన్ని సరిచేయండి';

  @override
  String get memoryClearedSuccess => 'మీ గురించిన Carry యొక్క జ్ఞాపకం సరిచేయబడింది';
  ...
  String get translationNoticeMessage =>
      'Carry సంభాషణలను మీ ప్రాధమిక భాషకు అనువదిస్తుంది. సెట్టింగ్‌లు → ప్రొఫైల్‌లలో ఏ సమయానికీ దీన్ని నవీకరించండి.';
  ...
  @override
  String get omiSyncsAudioFiles => 'Carry అప్పుడు ఆడియో ఫైల్‌లను సర్వర్‌తో సింక్ చేస్తుంది';
  ...
  String get welcomeToOmiDescription =>
      'Carry కు స్వాగతం! మీ AI సঙ్గి సంభాషణలు, పనులు మరియు మరిన్నింటితో మీకు సహాయ చేయడానికి సిద్ధంగా ఉంది.';

  @override
  String get startUsingOmi => 'Carry ఉపయోగం ప్రారంభించండి';
  ...
  String get startCapturingConversations =>
      'మీ Carry డివైస్‌తో సంభాషణలను సంపాదించడం ప్రారంభించండి వాటిని ఇక్కడ చూడటానికి.';
  ...
  @override
  String get noTasksForToday => 'ఈ రోజుకు పనులు లేవు.\nCarry నుండి మరిన్ని పనులను అడగండి లేదా మానవీయంగా సృష్టించండి.';
  ...
  @override
  String get buildSubmitCustomOmiApp => 'మీ కస్టమ్ Carry అ్యాప్‌ని నిర్మించండి మరియు సమర్పించండి';
  ...
  String get submitAppTermsAgreement =>
      'ఈ అ్యాప్‌ను సమర్పించడం ద్వారా, నేను Carry AI సేవా నిబంధనలు మరియు గోప్యతా విధానానికి అంగీకరిస్తున్నాను';
  ...
  String get dataAccessWarning =>
      'ఈ అ్యాప్ మీ డేటాకు ప్రాప్యత కలిగి ఉంటుంది. Carry AI ఈ అ్యాప్ ద్వారా మీ డేటా ఎలా ఉపయోగించబడుతుంది, సవరించబడుతుంది లేదా తొలగించబడుతుంది చేత్వం కోసం బాధ్యత వహించదు';
  ...
  @override
  String get getOmiDevice => 'Carry డివైస్ పొందండి';
  ...
  @override
  String get permanentlyRemoveAllMemories => 'Carry నుండి సమస్త స్మృతులను శాశ్వతంగా తీసివేయండి';
  ...
  @override
  String get clearOmisMemory => 'Carry స్మృతిని క్లియర్ చేయండి';

  @override
  String clearMemoryConfirmation(int count) {
    return 'Carry స్మృతిని క్లియర్ చేయాలని మీరు నిశ్చితమైనారా? ఈ చర్యను రద్దు చేయలేము మరియు $count స్మృతులన్నింటిని శాశ్వతంగా తొలగిస్తుంది.';
  }

  @override
  String get omisMemoryCleared => 'మీ గురించి Carry స్మృతి క్లియర్ చేయబడింది';

  @override
  String get welcomeToOmi => 'Carry కు స్వాగతం';
  ...
  @override
  String get selectPreferredLanguageForBestExperience => 'ఉత్తమ Carry అనుభవం కోసం మీ ఇష్ట భాషను ఎంచుకోండి';
  ...
  String get tellUsHowYouWouldLikeToBeAddressed =>
      'మీరు ఎలా సంబోధించాలనుకుంటున్నారో చెప్పండి. ఇది మీ Carry అనుభవాన్ని వ్యక్తిగతీకరించడానికి సహాయపడుతుంది.';
  ...
  @override
  String get enableFeaturesForBestExperience => 'మీ పరికరంలో ఉత్తమ Carry అనుభవం కోసం ఫీచర్‌లను ప్రారంభించండి.';
  ...
  String get microphoneAccessDescription =>
      'మీ సంభాషణలను రికార్డ్ చేయడానికి మరియు ట్రాన్‌స్‌క్రిప్షన్‌లను అందించడానికి Carry కు మైక్రోఫోన్ యాక్సెస్ అవసరం.';
  ...
  String get screenRecordingDescription =>
      'మీ బ్రౌజర్-ఆధారిత సమావేశాల నుండి సిస్టమ్ ఆడియోను సంగ్రహించడానికి Carry కు స్క్రీన్ రికార్డింగ్ అనుమతి అవసరం.';
  ...
  String get accessibilityDescription =>
      'మీ బ్రౌజర్‌లో Zoom, Meet లేదా Teams సమావేశాలకు చేరిక చేసినప్పుడు గుర్తించడానికి Carry కు యాక్సెసిబిలిటీ అనుమతి అవసరం.';
  ...
  @override
  String get teachOmiYourVoice => 'Carry కు మీ వాయిస్ నేర్పండి';

  @override
  String get tellOmiWhoSaidIt => 'Carry కు ఎవరు చెప్పారో చెప్పండి 🗣️';
  ...
  String get helpImproveOmiBySharing =>
      'నామరూప విశ్లేషణ డేటాను భాగస్వామ్యం చేయడం ద్వారా Carry ను మెరుగుపరచడానికి సహాయ చేయండి';
  ...
  String get mcpDescription =>
      'Carry ను ఇతర అ్యాప్లికేషన్‌లతో కనెక్ట్ చేయడానికి మీ జ్ఞాపనలు మరియు సంభాషణలను చదవడానికి, శోధించడానికి మరియు నిర్వహించడానికి. ప్రారంభించడానికి కీని సృష్టించండి.';
  ...
  @override
  String get tryLatestExperimentalFeatures => 'Carry టీమ్ నుండి సరికొత్త ప్రయోగాత్మక ఫీచర్‌లను ప్రయత్నించండి.';
  ...
  @override
  String get letOmiChooseAutomatically => 'Carry ఉత్తమ అ్యాప్‌ను స్వయంచాలకంగా ఎంచుకోనివ్వండి';
  ...
  @override
  String get translatedByOmi => 'carry ద్వారా అనువదించబడింది';
  ...
  @override
  String get addWordsDescription => 'Carry ట్రాన్‌స్‌క్రిప్షన్ సమయంలో గుర్తించాలని కోరుకునే పదాలను జోడించండి.';
  ...
  @override
  String get connectOmiWithAI => 'Carry ను AI సహాయకులతో కనెక్ట్ చేయండి';
  ...
  @override
  String get bySubmittingYouAgreeToOmi => 'సమర్పణ ద్వారా, మీరు Carry ';
  ...
  String get dataAccessNoticeDescription =>
      'ఈ అ్యాప్ మీ డేటాను యాక్సెస్ చేస్తుంది. Carry AI ఈ అ్యాప్ ద్వారా మీ డేటా ఎలా ఉపయోగించబడుతుంది, సవరించబడుతుంది లేదా తొలగించబడుతుందో వానికి బాధ్యత లేనిది';
  ...
  @override
  String get omiApiKeys => 'Carry API కీలు';

  @override
  String get apiKeysDescription =>
      'API కీలు మీ అ్యాప్ CARRY సర్వర్‌తో సంభాషణ చేసినప్పుడు ప్రామాణీకరణ కోసం ఉపయోగించబడతాయి. అవి మీ అ్యాప్‌కు జ్ఞాపనలను సృష్టించడానికి మరియు ఇతర CARRY సేవలను సురక్షితంగా యాక్సెస్ చేయడానికి అనుమతిస్తాయి.';

  @override
  String get aboutOmiApiKeys => 'Carry API కీల గురించి';
  ...
  String get e2eeDescription =>
      'చివర నుండి చివర ఎన్‌క్రిప్షన్ గోప్యతకు పేద ప్రమాణం. ఈనాబిల్ చేసినప్పుడు, మీ డేటా మీ పరికరంపై ఎన్‌క్రిప్ట్ చేయబడుతుంది అది మా సర్వర్‌లకు పంపబడుముందు. అంటే, ఎవరూ కాదు, Carry కూడా మీ విషయవస్తువను యాక్సెస్ చేయలేరు.';
  ...
  String get secureEncryptionDescription =>
      'మీ డేటా Google క్లౌడ్‌లో హోస్ట్ చేయబడిన మీ సర్వర్‌లలో మీకు సంబంధించిన కీ ద్వారా ఎన్‌క్రిప్ట్ చేయబడుతుంది. అంటే, మీ ముడి విషయవస్తువు డేటాబేస్ నుండి ఎవరికీ సమర్థించలేమని, Carry సిబ్బందికీ లేదా Google కీ.';
  ...
  @override
  String get omiTraining => 'Carry శిక్షణ';
  ...
  String get getOmiUnlimitedFree =>
      'AI నమూనాలను శిక్షణ ఇవ్వటానికి మీ డేటాకు సహకరించడం ద్వారా Carry అనీమితాన్ని ఉచితంగా పొందండి.';
  ...
  @override
  String get learnMoreAtOmiTraining => 'carry.me/training లో మరిన్ని తెలుసుకోండి';
  ...
  @override
  String get yourOmiUnleashed => 'మీ Carry, విడుదల చేయబడింది. అన్‌లిమిటెడ్‌కు వెళ్లండి అంతులేని సম్ভావ్యతల కోసం.';
  ...
  @override
  String get askOmiAnything => 'మీ జీవితం గురించి Carry కి ఏదైనా అడగండి';

  @override
  String get unlockOmiInfiniteMemory => 'Carry యొక్క అనంత జ్ఞాపకం అన్‌లాక్ చేయండి';
  ...
  String get privacyIntroText =>
      'Carry లో, మేము మీ గోప్యతను చాలా జరుపుకుంటాము. మేము మీ కోసం ఉత్పన్నమైన డేటా గురించి పారదర్శకంగా ఉండాలనుకుంటాము మరియు దానిని ఎలా ఉపయోగిస్తున్నాము. మీరు తెలుసుకోవలసిన విషయం ఇది:';
  ...
  String get commitmentText =>
      'మేము సేకరించిన డేటాను Carry ను మీ కోసం మెరుగైన ఉత్పన్నం చేయడానికి మాత్రమే ఉపయోగించాలని ప్రతిశ్రుతిబద్ధులు. మీ గోప్యత మరియు నమ్మకం మాకు అత్యంత ముఖ్యమైనవి.';

  @override
  String get thankYouText =>
      'Carry యొక్క విలువైన వినియోగదారుగా ఉన్నందుకు ధన్యవాదాలు. మీకు ఏవైనా ప్రశ్నలు లేదా ఆందోళనలు ఉంటే, team@basedhardware.com కు సంప్రదించడానికి సంకోచించకండి.';
  ...
  @override
  String get omiHas => 'Carry ఉన్నది:';
  ...
  String get howPeopleWorks =>
      'ఒక వ్యక్తి సృష్టించిన తర్వాత, మీరు సంభాషణ ట్రాన్‌స్క్రిప్ట్‌కు వెళ్లవచ్చు మరియు వారిని తమ సంబంధిత సెగ్మెంట్‌లకు కేటాయించవచ్చు, ఈ విధంగా Carry వారి ప్రసంగాన్ని కూడా గుర్తించగలుగుతుంది!';
  ...
  @override
  String get installOmiOnAppleWatch => 'Carry ని మీ\nApple Watch లో ఇన్‌స్టాల్ చేయండి';

  @override
  String get installOmiOnAppleWatchDescription =>
      'మీ Apple Watch ని Carry ఉపయోగించడానికి, మీరు ముందుగా మీ గడియారం మీద Carry అనువర్తనాన్ని ఇన్‌స్టాల్ చేయాలి.';

  @override
  String get openOmiOnAppleWatch => 'Carry ని మీ\nApple Watch లో తెరవండి';

  @override
  String get openOmiOnAppleWatchDescription =>
      'Carry అనువర్తనం మీ Apple Watch న ఇన్‌స్టాల్ చేయబడింది. దానిని తెరవండి మరియు ప్రారంభించడానికి ట్యాప్ చేయండి.';
  ...
  String get unableToOpenWatchApp =>
      'Apple Watch అనువర్తనాన్ని తెరవలేకపోయాను. దయచేసి మీ Apple Watch పై గడియార అనువర్తనాన్ని నిర్ణయం చేసి \"అందుబాటులో ఉన్న అనువర్తనాలు\" విభాగం నుండి Carry ని ఇన్‌స్టాల్ చేయండి.';
  ...
  String get appleWatchNotReachable =>
      'Apple Watch ఇప్పటికీ నిరన్తరం కనబడటం లేదు. దయచేసి Carry అనువర్తనం మీ గడియారం మీద తెరిచి ఉందని నిర్ధారించుకోండి.';
  ...
  @override
  String get updateOmiFirmware => 'Carry ఫర్మ్‌వేర్‌ను అప్‌డేట్ చేయండి';
  ...
  @override
  String get addVocabularyDescription => 'Carry ట్రాన్‌స్క్రిప్షన్ సమయంలో గుర్తించాల్సిన పదాలను జోడించండి.';
  ...
  @override
  String get wrappedOmiLifeRecap => 'Carry జీవితం పునర్బడ్డ';

  @override
  String get wrappedSwipeUpToBegin => 'ప్రారంభించడానికి పైకి స్వైప్ చేయండి';

  @override
  String get wrappedShareText => 'నా 2025, Carry చేత గుర్తుచేసుకోబడింది ✨ carry.me/wrapped';
  ...
  @override
  String get wrappedRememberedByOmi => 'Carry చేత గుర్తుచేసుకోబడింది';
  ...
  @override
  String get controlNotificationFrequency => 'Carry మీకు సక్రియ నోటిఫికేషన్‌లను ఎంత తరచుగా పంపుతుందో నియంత్రించండి.';
  ...
  String get notificationFrequencyDescription =>
      'Carry మీకు సక్రియ నోటిఫికేషన్‌లు మరియు రిమైండర్‌లను ఎంత తరచుగా పంపుతుందో నియంత్రించండి.';
  ...
  @override
  String get audioFromOmiWillAppearHere => 'మీ Carry పరికరం నుండి ఆడియో ఇక్కడ కనిపిస్తుంది';
  ...
  @override
  String get considerOmiCloud => 'మెరుగైన పనితీరు కోసం Carry క్లౌడ్ ఉపయోగించటను పరిగణించండి.';
  ...
  String get omiTranscriptionOptimized =>
      'Carry యొక్క అంతర్నిర్మిత లైవ్ ట్రాన్‌స్క్రిప్షన్ స్వయంచాలక స్పీకర్ గుర్తింపు మరియు డయారిజేషన్‌తో రియల్-టైమ్ సంభాషణల కోసం ఆప్టిమైజ్ చేయబడింది.';
  ...
  String get setupQuestionsIntro =>
      'కొన్ని ప్రశ్నలకు సమాధానం ఇవ్వడం ద్వారా Carry మెరుగుపరచటానికి మాకు సహాయం చేయండి.  🫶 💜';

  @override
  String get setupQuestionProfession => '1. మీరు ఏ పనిలో ఉన్నారు?';

  @override
  String get setupQuestionUsage => '2. మీరు మీ Carry ఎక్కడ ఉపయోగించటానికి ప్రణాళిక చేస్తున్నారు?';
  ...
  @override
  String get batteryFullyChargedTitle => 'Carry పూర్తిగా చార్జ్ అయింది';

  @override
  String get batteryFullyChargedBody => 'మీ Carry పరికరం పూర్తిగా చార్జ్ అయింది. అన్‌ప్లగ్ చేయవచ్చు!';

  @override
  String get deviceDisconnectedNotificationTitle => 'మీ Carry పరికరం డిస్‌కనెక్ట్ చేయబడింది';

  @override
  String get deviceDisconnectedNotificationBody =>
      'మీ Carry ను ఉపయోగించిన్న కొనసాగించడానికి దయచేసి తిరిగి కనెక్ట్ చేయండి.';
  ...
  String firmwareUpdateAvailableDescription(String version) {
    return 'మీ Carry పరికరం కోసం కొత్త ఫర్మ్‌వేర్ అపడేట్ ($version) అందుబాటులో ఉంది. ఇప్పుడు అపడేట్ చేయాలనుకుంటున్నారా?';
  }
  ...
  @override
  String get omiSays => 'carry చెప్పింది';
  ...
  @override
  String get connectOmiDevice => 'Carry పరికరం కనెక్ట్ చేయండి';
  ...
  @override
  String get actionItemReminderTitle => 'Carry రిమైండర్';
  ...
  @override
  String get onboardingWelcomeToOmi => 'Carry కు స్వాగతం';
  ...
  @override
  String get pairingTitleOmi => 'Carry ను ఆన్ చేయండి';

  @override
  String get pairingDescOmi => 'పరికరం కంపించే వరకు బటన్‌ను నొక్కి ఉంచండి.';

  @override
  String get pairingTitleOmiDevkit => 'Carry DevKit ను జత చేయడానికి మోడ్‌లో ఉంచండి';
  ...
  @override
  String get pairingTitleOmiGlass => 'Carry Glass ను ఆన్ చేయండి';
  ...
  String get pairingDescAppleWatch =>
      'మీ Apple Watch లో Carry యాప్‌ను ఇన్‌స్టాల్ చేసి, తెరవండి, ఆపై యాప్‌లో కనెక్ట్‌ను నొక్కండి.';
  ...
  String get onboardingWhatIKnowAboutYouDescription =>
      'Carry మీ సంభాషణల నుండి నేర్చుకున్నందున ఈ మ్యాప్ నవీకరించబడుతుంది.';
  ...
  @override
  String get phoneCallsWithOmi => 'Carry తో ఫోన్ కాల్‌లు';
  ...
  @override
  String get phoneCallsUnlimitedOnly => 'Carry ద్వారా ఫోన్ కాల్‌లు';

  @override
  String get phoneCallsUpsellSubtitle =>
      'Carry ద్వారా కాల్‌లు చేయండి మరియు రియల్-టైమ్ ట్రాన్‌స్క్రిప్షన్, స్వయంచాలక సారాంశాలు మరియు మరిన్నిటిని పొందండి. అన్‌లిమిటెడ్ ప్లాన్ సబ్‌స్క్రైబర్‌ల కోసం ప్రత్యేకంగా అందుబాటులో ఉంది.';
  ...
  String get fairUseAboutBody =>
      'Carry వ్యక్తిగత సంభాషణలు, సమావేశాలు మరియు జీవంత పరిస్థితుల కోసం డిజైన్ చేయబడింది. ఉపయోగం కనెక్షన్ సమయం కాకుండా కనుగొనబడిన నిజమైన స్పీచ్ సమయం ద్వారా కొలుస్తారు. ఉపయోగం నిజమైన కాని నిజమైన కాని విషయవస్తువుల కోసం సాధారణ నమూనాలను గణనీయంగా మించిపోయినట్లయితే, సమన్వయాలు వర్తించవచ్చు.';
  ...
  String get improveConnectionContent =>
      'Carry మీ పరికరానికి కనెక్ట్ చేయబడిన విధానాన్ని మేము మెరుగుపరచాము. ఇది సక్రియం చేయడానికి, దయచేసి పరికరం సమాచారం పేజీకి వెళ్లండి, \"పరికరం డిస్‌కనెక్ట్ చేయండి\" నొక్కండి మరియు అప్పుడు మీ పరికరాన్ని మరోసారి జత చేయండి.';
  ...
  @override
  String get omisStorage => 'Carry యొక్క నిల్వ';
  ...
  String get omisStorageDesc =>
      'మీ Carry మీ ఫోన్‌కు కనెక్ట్ చేయనప్పుడు, ఇది నిర్మిత మెమరీపై స్థానికంగా ఆడియోను నిల్వ చేస్తుంది. మీరు ఎప్పటికీ రికార్డింగ్‌ను కోల్పోరు.';

  @override
  String get phoneStorageDesc =>
      'Carry మరోసారి కనెక్ట్ చేసినప్పుడు, రికార్డింగ్‌లు స్వయంచాలకంగా మీ ఫోన్‌కు అప్‌లోడ్ చేయడానికి ముందు తాత్కాలిక హోల్డింగ్ ఆ రూపంగా బదిలీ చేయబడతాయి.';
  ...
  String get permissionsPageDescription =>
      'ఈ అనుమతులు Carry ఎలా పని చేస్తుంది అనేటువంటి ప్రధానమైనవి. అవి నోటిఫికేషన్‌లు, స్థానం-ఆధారిత అనుభవాలు మరియు ఆడియో సంగ్రహణ వంటి ముఖ్య లక్షణాలను ఎనేబుల్ చేస్తాయి.';

  @override
  String get permissionsRequiredDescription =>
      'Carry సరిగ్గా పని చేయడానికి కొన్ని అనుమతులు అవసరం. దయచేసి కొనసాగించటానికి వాటిని ఇవ్వండి.';

  @override
  String get permissionsSetupTitle => 'ఉత్తమ అనుభవం పొందండి';

  @override
  String get permissionsSetupDescription => 'Carry తన మేజిక్ పని చేయడానికి కొన్ని అనుమతులను ప్రారంభించండి.';
  ...
  @override
  String get feedbackTitleNotUsing => 'Carry ను మరింత ఉపయోగించడానికి ఏ చేస్తుంది?';
  ...
  @override
  String get feedbackSubtitleNotUsing => 'Carry కు మీకు మరింత ఉపయోగకరంగా చేయాలనుకుంటున్నాము.';
  ...
  String get appleHealthManageNote =>
      'Carry Apple యొక్క HealthKit ఫ్రేమ్‌వర్క్ ద్వారా Apple Health ను యాక్సెస్ చేస్తుంది. మీరు ఎప్పుడైనా iOS సెట్టింగ్‌ల నుండి యాక్సెస్‌ను ఉపసంహరించుకోవచ్చు.';
  ...
  @override
  String get appleHealthFeatureChatDesc => 'Carry ను మీ అడుగులు, నిద్ర, గుండె రేటు మరియు వర్కవుట్‌ల గురించి అడగండి.';

  @override
  String get appleHealthFeatureReadOnlyTitle => 'చదవడానికి మాత్రమే యాక్సెస్';

  @override
  String get appleHealthFeatureReadOnlyDesc => 'Carry Apple Health కు ఎప్పుడూ వ్రాయదు లేదా మీ డేటాను మార్చదు.';

  @override
  String get appleHealthFeatureSecureTitle => 'సురక్షిత సమకాలీకరణ';

  @override
  String get appleHealthFeatureSecureDesc => 'మీ Apple Health డేటా ప్రైవేట్‌గా మీ Carry ఖాతాకు సమకాలీకరించబడుతుంది.';
  ...
  String get appleHealthDeniedBody =>
      'Carry కి మీ Apple Health డేటాను చదవడానికి అనుమతి లేదు. iOS సెట్టింగ్‌లు → గోప్యత & భద్రత → Health → Carry లో దీన్ని ప్రారంభించండి.';

  @override
  String get deleteFlowReasonTitle => 'మీరు ఎందుకు వెళ్తున్నారు?';

  @override
  String get deleteFlowReasonSubtitle => 'మీ అభిప్రాయం అందరికీ Carry-ని మెరుగుపరచడంలో మాకు సహాయపడుతుంది.';
  ...
  @override
  String get deleteFlowFeedbackSubtitle => 'Carry మీకు ఎలా పని చేసేది?';
  ...
  String get chatQuotaExceededReply =>
      'మీరు మీ నెలవారీ పరిమితిని చేరుకున్నారు. పరిమితులు లేకుండా Carry తో చాట్ కొనసాగించడానికి అప్‌గ్రేడ్ చేయండి.';

  @override
  String get voiceResponseAudio => 'Carry ప్రతిస్పందనను బిగ్గరగా చదవండి';
  ...
  @override
  String get quickActionAskOmi => 'Carry ని ఏమైనా అడగండి';
  ...
  @override
  String get syncStatusUploaded => 'అప్‌లోడ్ అయింది · Carryలో ప్రాసెస్ అవుతోంది';
  ...
  String get deleteWhileProcessingMessage =>
      'ఈ రికార్డింగ్ అప్‌లోడ్ అయింది కానీ Carry ఇంకా సంభాషణను సృష్టిస్తోంది. ఇప్పుడు తొలగిస్తే మరియు ప్రాసెసింగ్ విఫలమైతే, దాన్ని తిరిగి పొందలేరు. అయినా తొలగించాలా?';
  ...
  @override
  String get syncCardProcessing => 'Carryలో ప్రాసెస్ అవుతోంది…';
  ...
  String get syncFlowIntro =>
      'రికార్డింగ్‌లు మీ పరికరం నుండి ఈ ఫోన్‌కు బదిలీ చేయబడి స్థానికంగా నిల్వ చేయబడతాయి, ఆ తర్వాత Carry సర్వర్‌కు అప్‌లోడ్ చేయబడతాయి, అక్కడ అవి లిప్యంతరీకరించబడి సంభాషణలుగా మార్చబడతాయి.';

  @override
  String get syncStepUpload => 'సింక్';

  @override
  String get syncStepUploadDesc => 'మీ రికార్డింగ్ Carry సర్వర్‌కు పంపబడుతుంది';

  @override
  String get syncStepProcess => 'లిప్యంతరీకరణ';

  @override
  String get syncStepProcessDesc => 'Carry ఆడియోను సంభాషణగా మారుస్తుంది';
  ...
  @override
  String get syncCardUploadingTitle => 'Carry కి అప్‌లోడ్ అవుతోంది';
  ...
  String get syncCardBackendBusy =>
      'Carry సర్వర్‌లు బిజీగా ఉన్నాయి — సామర్థ్యం అందుబాటులోకి వచ్చిన వెంటనే మీ రికార్డింగ్‌లు సింక్ అవుతాయి';
  ...
  @override
  String get backgroundModeDescription => 'యాప్ పూర్తిగా మూసివేయబడినా మీ Carry రికార్డింగ్‌ను కొనసాగించండి.';

  @override
  String get backgroundModeNote => 'ప్రస్తుతం Carry పరికరాలతో మాత్రమే పనిచేస్తుంది మరియు నిరంతరం మెరుగుపరచబడుతోంది.';
  ...
  @override
  String get syncCustomSttWarningTitle => 'సింక్ Carry ట్రాన్స్‌క్రిప్షన్‌ను ఉపయోగిస్తుంది';

  @override
  String get syncCustomSttWarningMessage =>
      'మీరు మీ సొంత ట్రాన్స్‌క్రిప్షన్ ప్రొవైడర్‌ను ఉపయోగిస్తున్నారు. ఈ రికార్డింగ్‌లను సింక్ చేస్తే అవి Carry సర్వర్‌లలో ట్రాన్స్‌క్రైబ్ చేయబడతాయి మరియు మీ ప్లాన్ ట్రాన్స్‌క్రిప్షన్ పరిమితిలో లెక్కించబడతాయి.';
}
