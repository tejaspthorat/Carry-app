...
class AuthService {
  ...
  Future<UserCredential?> signInWithGoogleMobile() async {
    ...
    final configuredGoogleClientId = Env.googleClientId?.trim();
    final GoogleSignInAccount? googleUser = await GoogleSignIn(
      scopes: ['profile', 'email'],
      serverClientId: configuredGoogleClientId != null && configuredGoogleClientId.isNotEmpty ? configuredGoogleClientId : null,
    ).signIn();
